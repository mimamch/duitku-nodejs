test('Request transaction QRIS', done => {
    ...
    let transaction = new Transaction(10000, "SP", Date.now().toString(), "Test Payment")
    ...
    function callback(resp, error) {
        ...
        try{
            ...
            expect(resp.vaNumber).toBeUndefined()
            expect(typeof resp.qrString).toMatch("string")
